...
// Fallback para a URL e a chave pública (anon) do projeto Supabase do Foco
// Personal — seguro expor no client, é exatamente para isso que essa chave
// existe (o controle de acesso real fica nas policies de RLS do banco).
